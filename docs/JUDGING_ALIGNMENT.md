...
| Presentation & Documentation | Green in repository; video pending | `/app/inbox` is the primary judge route and `/app/connect` makes the adoption boundary assessable. [`HACKATHON_WRITEUP.md`](../HACKATHON_WRITEUP.md), [`CONNECT.md`](../CONNECT.md), [`DEPLOYMENT_PROOF.md`](DEPLOYMENT_PROOF.md), and the pre-submit checklist mirror the same story. Record the final public video and attach real deployment evidence. |
